...
<section class="py-24 bg-slate-50">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach ([
                ['title'=>'Senior Product Designer','company'=>'Airbnb','location'=>'Remote Â· USA','salary'=>'$130kâ€“$160k','type'=>'Full-time','logo_letter'=>'A','logo_bg'=>'bg-rose-100','logo_text'=>'text-rose-600','tag'=>'Design'],
                ['title'=>'Backend Engineer (Node.js)','company'=>'Stripe','location'=>'San Francisco, CA','salary'=>'$150kâ€“$200k','type'=>'Full-time','logo_letter'=>'S','logo_bg'=>'bg-blue-100','logo_text'=>'text-blue-600','tag'=>'Engineering'],
                ['title'=>'Growth Marketing Lead','company'=>'Notion','location'=>'Remote Â· Global','salary'=>'$100kâ€“$130k','type'=>'Full-time','logo_letter'=>'N','logo_bg'=>'bg-gray-100','logo_text'=>'text-gray-700','tag'=>'Marketing'],
                ['title'=>'Data Analyst','company'=>'Shopify','location'=>'Ottawa, Canada','salary'=>'$90kâ€“$115k','type'=>'Hybrid','logo_letter'=>'S','logo_bg'=>'bg-green-100','logo_text'=>'text-green-600','tag'=>'Data'],
                ['title'=>'DevOps Engineer','company'=>'Vercel','location'=>'Remote Â· Europe','salary'=>'$120kâ€“$150k','type'=>'Full-time','logo_letter'=>'V','logo_bg'=>'bg-gray-900','logo_text'=>'text-white','tag'=>'Infrastructure'],
                ['title'=>'Customer Success Manager','company'=>'Linear','location'=>'New York, NY','salary'=>'$80kâ€“$105k','type'=>'Hybrid','logo_letter'=>'L','logo_bg'=>'bg-violet-100','logo_text'=>'text-violet-600','tag'=>'Operations'],
            ] as $job)
            ...
            <div>
                ...
                <ul class="space-y-4 mb-8">
                    @foreach ([
                        ...
                        'Applicant tracking built in â€” no extra tools needed',
