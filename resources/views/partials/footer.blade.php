    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-4">
                ...
                {{-- Twitter --}}
                <a href="#" class="hover:text-indigo-400 transition-colors" aria-label="Twitter">
                ...
                {{-- GitHub --}}
                <a href="#" class="hover:text-indigo-400 transition-colors" aria-label="GitHub">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                {{-- LinkedIn --}}
                <a href="#" class="hover:text-indigo-400 transition-colors" aria-label="LinkedIn">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
