...
<footer class="bg-gray-900 text-gray-400 py-16">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
                ...
                <p class="text-sm leading-relaxed">
                    Connecting exceptional talent with the world's best employers. PostPulse makes hiring faster, smarter, and more human.
                </p>
            </div>
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <p class="text-sm">© {{ date('Y') }} PostPulse. All rights reserved.</p>
            <div class="flex items-center gap-4">
                ...
                {{-- Instagram --}}
                <a href="#" class="hover:text-[#149696] transition-colors" aria-label="Instagram">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
